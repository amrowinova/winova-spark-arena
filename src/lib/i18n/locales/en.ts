export const en = {
  translation: {
    ...
    contests: {
      ...
      fridayReminder: 'Friday Free Contest Tomorrow — No Fees!',
      joinFree: 'Join Free',
      kycRequired: 'Identity verification (KYC) required for free contests',
      accountTooNew: 'Account must be 7 days old to join free contests',
      deviceAlreadyUsed: 'This device already used for this contest',
      voteRacing: 'Vote Racing',
      liveFeed: 'Live Feed',
      powerUps: 'Free Power-ups',
      mysteryBoxes: 'Mystery Prize Boxes',
      winnersReveal: 'Winners Reveal',
      ...
      celebrate: 'Celebrate',
      mostCelebrated: 'Most Celebrated',
      voteProgress: 'Vote Progress',
      voteDistribution: 'Vote Distribution',
      funInsights: 'Fun Insights',
      winnerSurge: 'Winner Surge',
      strongestMomentum: 'Strongest Momentum',
      powerUpUsage: 'Power-up Usage',
      closestCompetition: 'Closest Competition',
      totalVotes: 'Total Votes',
      activeUsers: 'Active Users',
      timeRemaining: 'Time Remaining',
      voteCount: 'Vote Count',
      bonusVotes: 'Bonus Votes',
      tieBreakRound: 'Tie-break Round',
      votingOpen: 'Voting Open',
      votingClosed: 'Voting Closed',
      contestEnded: 'Contest Ended',
      showPrizeValues: 'Show Prize Values',
      hidePrizeValues: 'Hide Prize Values',
      clickToOpen: 'Click to Open',
      boxesAppear: 'Boxes appear 3 minutes before end',
      revealingWinners: 'Revealing winners...',
      congratulations: '🎉 Congratulations to the Winners!',
      thanksParticipants: 'Thank you to all participants',
