export const tr = {
  translation: {
    ...
    contests: {
      ...
      fridayContest: 'Ücretsiz Cuma Yarışması',
      fridayReminder: 'Yarın Cuma yarışması — giriş ücreti yok!',
      joinFree: 'Ücretsiz Katıl',
      kycRequired: 'Kimlik doğrulama (KYC) gereklidir',
      accountTooNew: 'Hesabınızın en az 7 günlük olması gerekiyor',
  ...
  giving: {
    title: 'Bağış',
    subtitle: 'Nova bakiyenizle ihtiyaç sahibi aileleri destekleyin',
    families: 'Aileler',
    support: 'Aile Destekle',
    supportNow: 'Destekle',
    members: 'üye',
    totalReceived: 'Toplam alınan',
    needScore: 'İhtiyaç skoru',
    chooseAmount: 'Miktar seçin',
    confirm: 'Bağışla',
    thankYou: 'Teşekkürler! Desteğiniz büyük fark yaratıyor.',
    noFamilies: 'Mevcut aile yok',
    alreadySupported: 'Bu aileyi zaten desteklediniz',
  },
};
