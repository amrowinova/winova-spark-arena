...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // SECURITY: Validate caller is service-role or admin
    ...
    if (!isServiceRole) {
      ...
      const tempClient = createClient(supabaseUrl, supabaseServiceKey, { auth: { autoRefreshToken: false, persistSession: false } });
