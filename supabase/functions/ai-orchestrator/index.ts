...
const INTENT_MAP: Record<string, { agent: string; intent: string }> = {
  ...
  'commander': { agent: 'ai-commander', intent: 'commander_briefing' },
  'قائد': { agent: 'ai-commander', intent: 'commander_briefing' },
  'summary': { agent: 'ai-commander', intent: 'commander_briefing' },
  'ملخص': { agent: 'ai-commander', intent: 'commander_briefing' },
  'priorities': { agent: 'ai-commander', intent: 'commander_briefing' },
  'أولويات': { agent: 'ai-commander', intent: 'commander_briefing' },
  'workforce': { agent: 'ai-commander', intent: 'workforce_review' },
  'قوى عاملة': { agent: 'ai-commander', intent: 'workforce_review' },
  'agents': { agent: 'ai-commander', intent: 'workforce_review' },
  'وكلاء': { agent: 'ai-commander', intent: 'workforce_review' },
