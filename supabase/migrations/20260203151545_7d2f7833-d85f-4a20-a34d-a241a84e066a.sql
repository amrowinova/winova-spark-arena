...
-- To revert: change interval '20 hours' back to '18 hours'
-- =====================================================
...
begin
  ...
  -- TEMP: Join window extended for testing: 10:00–20:00 KSA (end of Stage 1)
  -- Original: 10:00–18:00 KSA
  v_join_open := date_trunc('day', v_ksa_now) + interval '10 hours';
  v_join_close := date_trunc('day', v_ksa_now) + interval '20 hours';  -- TEMP: was 18 hours
  ...
  -- Registration eligibility is time-based (10:00–20:00 KSA for testing).
