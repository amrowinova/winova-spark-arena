-- ============================================================
-- تغيير توقيت المسابقة: منتصف الليل → 20:00
-- ============================================================
-- التغيير:
--   join_contest RPC: إغلاق التسجيل من 19:00 → 20:00 KSA
--   المسابقة الآن: 00:00 – 20:00 (فترة واحدة للتسجيل والتصويت)
-- ============================================================
...
BEGIN
  ...
  -- ② وقت الانضمام (00:00 – 20:00 KSA) — المسابقة مفتوحة طوال اليوم
